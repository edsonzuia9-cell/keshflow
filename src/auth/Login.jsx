  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError(err.message === 'Invalid login credentials' 
        ? 'E-mail ou senha incorretos. Tenta novamente.' 
        : err.message);
    } finally {
      setLoading(false);
    }
    ...
    <div style={styles.page}>
      <div style={styles.container} className="animate-fade-in">
        ...
        <div style={styles.logoSection}>
          ...
          <p style={styles.tagline}>Gestão financeira académica, simplificada.</p>
        </div>
        ...
        <div style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <p style={styles.cardSubtitle}>Entra na tua conta para gerires a tua bolada.</p>
          </div>
